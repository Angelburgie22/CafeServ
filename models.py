...
class UserAccount(Model):
    ...
    creation_time: Mapped[str] = mapped_column(DateTime, nullable=False)
    ...
    apellido_p: Mapped[str] = mapped_column(String(24))
    apellido_m: Mapped[str] = mapped_column(String(24))
